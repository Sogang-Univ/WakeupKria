...
# Stage 1 산출물 (KV260_Gesture_YOLO_GRU_Finetuning 노트북)
...
EXPECTED_CLASS_NAMES = ["open_palm", "fist", "thumb_up", "thumb_down"]

# 학습 시 STAGE1_IMGSZ = 416. 320 으로 낮추면 손(40~60px)이 25px 로 줄어 형태 구분이 무너진다.
...
class QuantizeConfig:
    ...
    seed: int = 42
    arch: str = None
    net_name: str = "gesture_stage1_kv260"
...
def parse_args():
    ...
    parser.add_argument("--net-name", type=str, default="gesture_stage1_kv260", help="Compiled xmodel name")
    parser.add_argument(
        "--skip-compile",
        action="store_true",
